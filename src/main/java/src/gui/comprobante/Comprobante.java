...
public class Comprobante extends javax.swing.JFrame {
     ...
     * PdfTemplate template = cb.createTemplate(PageSize.A4.getWidth(),
     * PageSize.A4.getHeight());
     * cb.addTemplate(template, 0, 0);
     * 
     * Graphics2D g2d = template.createGraphics(PageSize.A4.getWidth(),
     * PageSize.A4.getHeight());
     * g2d.scale(0.4, 0.4);
     * 
     ...
     * c.setBounds(0, 0, (int) PageSize.A4.getWidth() * 2, (int)

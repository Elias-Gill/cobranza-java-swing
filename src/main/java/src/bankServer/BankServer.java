...
public class BankServer {
	...
	/**
	 * Funcion para iniciar y establecer la conexion con la base de datos. Solo se utiliza
	 * durante el inicio.
	 *
	 * @return
	 */
	...
	/**
	 * Realiza una nueva transferencia de dinero entre dos cuentas. Realiza las comprobaciones y
	 * la actualizacion del los saldos de ambas cuentas.
	 *
	 * @param t
	...
	public DatosComprobante NuevaTransferencia(Transferencia t)
		...
		t.cuentaOrigen = origen.nroCuenta;
	...
	/**
	 * Realiza un nuevo deposito de dinero a una cuenta. Realiza la comprobacion y la
	 * actualizacion del saldo correspondiente.
	 *
	 * @param d
	 * @return DatosComprobante
	 * @throws ClassNotFoundException
	...
	/**
	 * Funcion que solo retorna la deuda de un determinado servicio. No requiere de parametros
	 * especiales, solo el ID del servicio.
	 *
	 * @param idServicio
	...
	/**
	 * Funcion que realiza el pago de un determinado servicio. Se encarga de "conectarse" al
	 * servicio, realizar las comprobaciones necesarias y generar un descuento del saldo de la
	 * cuenta o aumentar la deuda de la tarjeta de credito, dependiendo del metodo de pago
	 * escogido.
	 *
	 * @param p
	 * @return DatosComprobante
	...
	/**
	 * Funcion para realizar el pago de la deuda de alguna tarjeta asociada a una cuenta. La
	 * dueda se descuenta de la tarjeta, el saldo aumenta y se resta del saldo de la cuenta del
	 * cliente.
	 *
	 * @param c
	 * @param monto
	...
	public DatosComprobante PagarTarjeta(int cedula, int monto) throws SQLException, ClassNotFoundException {
		...
		DatosComprobante dc = new DatosComprobante(cuenta.nroCuenta, monto, "pagoTarjeta");
		gr.nuevoRegistro(dc);
		return dc;
	}
	 ...
	 * @throws SQLException
	 */
	public ArrayList<DatosComprobante> getRegistrosCuenta(int cuenta) throws SQLException {
		String query = String.format("SELECT * FROM Registro WHERE cuenta_origen=%d OR cuenta_destino=%d", cuenta,
		    cuenta);

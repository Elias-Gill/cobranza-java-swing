 ...
 */
public class formularioTransferencia extends javax.swing.JFrame {

    /**
     * Creates new form formularioTransferencia
     */
    public formularioTransferencia(DatosFormulario Datos) {
        initComponents();
        int CuentaDestino = Datos.CuentaDestino;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Formulario de Transferencia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formularioTransferencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new formularioTransferencia(datos).setVisible(true);
            }
        });
    }

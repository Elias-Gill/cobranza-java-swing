...
public class Prueba {
    ...
    private static void createAndShowGUI() {
        FlatDarkLaf
                .setup(); // Must be called first of all Swing code as this sets the look and feel
                          // to
        // FlatDark.
    ...
    public static void labels(
            JLabel label, String texto, JPanel panel, GridBagConstraints posicion) {
        label.setText(texto);
        panel.add(label, posicion);
    }

    public static void posicionGrilla(
            GridBagConstraints posicion, int fila, int columna, int ancho, int largo) {
        posicion.gridy = fila;
